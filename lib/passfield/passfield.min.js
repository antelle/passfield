...
'"></div>')),E(L,a),I()),T=!0,!1;da();return!0}function da(){Y=null;w&&(E(w,""),w.title="",g.errorWrapClassName&&W(s,g.errorWrapClassName,!0));u&&W(u,"tip-shown");T=!1}function X(c,a){for(var b={},d=0;d<c.length;d++){var e=c.charAt(d),f=a;h.each(g.chars,function(a,c){return 0<=c.indexOf(e)?(f=a,!1):!0});b[f]=(b[f]||"")+e}return b}function r(c,a,b){a.id&&(a.id=H+a.id+"-"+J);a.className&&(a.className=H+a.className);return h.newEl(c,a,b)}function ea(c){return"function"===typeof c.getBoundingClientRect?
c.getBoundingClientRect():{top:0,left:0}}function fa(c){var a=c.ownerDocument;if(!a)return{top:0,left:0};c=ea(c);return{top:c.top+G.pageYOffset-a.documentElement.clientTop,left:c.left+G.pageXOffset-a.documentElement.clientLeft}}function ga(c){var a,b={top:0,left:0};if("fixed"===Q(c,"position"))a=ea(c);else{var d;for(a=c.offsetParent||y.documentElement;a&&"html"!=a.nodeName.toLowerCase()&&"static"===Q(a,"position");)a=a.offsetParent;d=a||y.documentElement;a=fa(c);"html"!=d.nodeName.toLowerCase()&&
(b=fa(d));b.top+=B(d,"borderTopWidth");b.left+=B(d,"borderLeftWidth")}return{top:a.top-b.top-B(c,"marginTop"),left:a.left-b.left-B(c,"marginLeft")}}function $(c){return h.extend(ga(c),{width:c.offsetWidth,height:c.offsetHeight})}function M(c,a){h.each(a,function(a,b){c.style[a]=b+"px";"height"==a&&(c.style.lineHeight=b+"px")})}function Q(c,a){var b="function"===typeof G.getComputedStyle?G.getComputedStyle(c):c.currentStyle;return b?b[a]:null}function B(c,a){var b=Q(c,a);if(!b)return 0;b=parseFloat(b);
return isNaN(b)?0:b}function F(c,a){c.parentNode.insertBefore(a,c.nextSibling)}function E(c,a){try{c.innerHTML=a}catch(b){var d=y.createElement();for(d.innerHTML=a;c.firstChild;)c.removeChild(c.firstChild);c.appendChild(d)}}function x(c,a,b){V(c,a,b)||(c.className=c.className+(c.className?" ":"")+(!0===b?a:H+a))}function W(c,a,b){V(c,a,b)&&(c.className=(" "+c.className+" ").replace((!0===b?a:H+a)+" ","").replace(/^\s+|\s+$/g,""))}function V(c,a,b){a=" "+(!0===b?a:H+a)+" ";return-1<(" "+c.className+
" ").replace(/[\n\t]/g," ").indexOf(a)}var l=m.Config;p=L=u=K=t=n=w=j=s=d=void 0;var g=h.extend({},l.defaults,e),A=!0,k,J,C,O,T=!1,Y=null,z,ca,H="a_pf-";this.toggleMasking=function(c){P(c)};this.setPass=function(c){d.value=c;j.value=c;S()};this.validatePass=N;this.getPassValidationMessage=function(){return Y};z=-1;"Microsoft Internet Explorer"==navigator.appName&&(f=/MSIE ([0-9]{1,}[.0-9]{0,})/.exec(navigator.userAgent),null!=f&&(z=parseFloat(f[1])));if(ca=0>z||6<=z)if(g.showGenerate&&!g.showToggle&&
(g.isMasked=!1),g.blackList=(g.blackList||[]).concat(m.Config.blackList),"string"==typeof b&&(b=y.getElementById(b)),d=b){f=g.locale;!f&&navigator.language&&(f=navigator.language.replace(/\-.*/g,""));f&&(k=l.locales[f]);k&&(k=h.extend({},l.locales.en,k));k||(k=h.extend({},l.locales.en));g.localeMsg&&h.extend(k.msg,g.localeMsg);J=d.id;J||(J="i"+Math.round(1E5*Math.random()),d.id=J);l=!0;"placeholder"in y.createElement("input")||(l=!1);f=y.createElement("div");f.style.paddingLeft=f.style.width="1px";
y.body.appendChild(f);y.body.removeChild(f);f=l;var D=$(d);D.top+=B(d,"marginTop");l=D.height+"px";x(d,"txt-pass");s=d.parentNode;x(s,"wrap");j=r("input",{type:"text",id:"txt-clear",className:"txt-clear",placeholder:d.placeholder,value:d.value});var R=d.style.cssText;R&&(j.style.cssText=R);(R=d.getAttribute("maxlength"))&&j.setAttribute("maxlength",R);j.style.display="none";F(d,j);g.showWarn&&(w=r("div",{id:"warn",className:"warn"},{margin:"0 0 0 3px"}),g.warnMsgClassName&&x(w,g.warnMsgClassName,
...
t&&(t.onclick=function(){var c="",a=X(g.pattern,m.CharTypes.SYMBOL),b=[];h.each(a,function(a,c){for(var d=0;d<c.length;d++)b.push(a)});b.sort(function(){return 0.7-Math.random()});h.each(b,function(a){c+=h.selectRandom(g.chars[a])});j.value=d.value=c;P(!1);C&&clearTimeout(C);N();p&&(p.style.display="none")});p&&(p.onclick=function(){(A?d:j).focus()});P(g.isMasked,!1);d.hasAttribute("autofocus")&&(d.focus(),U());z=m.Config.dataAttr;q&&q(d).data(z,this)}};var h={extend:function(){for(var b=arguments,
e=1;e<b.length;e++)h.each(b[e],function(f,d){b[0][f]=h.isArray(b[e][f])||h.isArray(b[0][f])?b[0][f]?b[0][f].concat(d||[]):d:"object"===typeof b[0][f]&&"object"===typeof d?h.extend({},b[0][f],d):d});return b[0]},newEl:function(b,e,f){var d=y.createElement(b);e&&h.each(e,function(b,e){e&&(d[b]=e)});f&&h.each(f,function(b,e){e&&(d.style[b]=e)});return d},attachEvent:function(b,e,f){var d=b[e];b[e]=function(){f(b);"function"===typeof d&&d(b)}},each:function(b,e){if(h.isArray(b))for(var f=0;f<b.length&&
!1!==e(b[f]);f++);else for(f in b)if(Object.prototype.hasOwnProperty.call(b,f)&&!1===e(f,b[f]))break},isArray:function(b){return"[object Array]"===Object.prototype.toString.call(b)},selectRandom:function(b){var e=Math.floor(Math.random()*b.length);return h.isArray(b)?b[e]:b.charAt(e)},contains:function(b,e){if(!b)return!1;var f=!1;h.each(b,function(b){return b===e?(f=!0,!1):!0});return f}};q&&(q.fn.passField=function(b){return this.each(function(){new m.Field(this,b)})},q.fn.togglePassMasking=function(b){return this.each(function(){var e=
q(this).data(m.Config.dataAttr);e&&e.toggleMasking(b)})},q.fn.setPass=function(b){return this.each(function(){var e=q(this).data(m.Config.dataAttr);e&&e.setPass(b)})},q.fn.validatePass=function(){var b=!0;this.each(function(){var e=q(this).data(m.Config.dataAttr);e&&!e.validatePass()&&(b=!1)});return b},q.fn.getPassValidationMessage=function(){var b=this.first();return b&&(b=b.data(m.Config.dataAttr))?b.getPassValidationMessage():null});q&&q.validator&&jQuery.validator.addMethod("passfield",function(b,
e){q(e).validatePass()},function(b,e){return q(e).getPassValidationMessage()})})(window.jQuery,document,window);
